 ...
 <!DOCTYPE html>
  <html>
    <head>
      ...
      <link rel="stylesheet" type="text/css" href="css/stylesucesso.css">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-2 col-md-offset-4">
              <a href="suporte.php" class="btn btn-lg btn-primary" id="grande"><i class="material-icons center" id="large"><br>arrow_back<br></i><br>Voltar a pagina suporte  <br><br> <div id="texto">Email enviado com sucesso...</div> </a>
            </div>
          </div>
        </div>
