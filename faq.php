 ...
 <!DOCTYPE html>
  <html>
    ...
    <body>
      ...
      <br>
      <a href="suporte.php" class="waves-effect waves-light btn"><i class="material-icons center">arrow_back</i><b> Voltar ao menu suporte</b></a>
      <br>
      <p>
      <br>
      </p>
      <br>
        ...
        <h1 class="white-text main-text" id="texto">Perguntas Frequentes</h1>
      <div class="container" id="drop">
          <div class="row">
            <div class="col-md-3">
              <button class="collasible "><b>1°Minha encomenda não chegou</b></button>
                <div class="content" id="cor">
                <p><br><b>Caso tenha ocorrido<br> um atraso em sua<br> encomenda, recomendamos<br> que você entre em<br> contato com o suporte imediatamente<br> através de um ticket a<br> qual iremos avaliar e solucionar a situação o mais rápido possível.</b></p>
                </div>
            </div>
            <div class="col-md-3 col-md-offset-1">
              <button class="collasible"><b>2° Como posso excluir minha conta</b></button>
                <div class="content" id="cor">
                <p><br><b>Você só poderá solicitar a exclusão de conta, se não houver nenhuma pendencia tais como (Venda, Compra, produto a caminho ao destinatário e etc.), caso contrário a sua solicitação será anulada.</b></p>
                </div>
            </div>
            <div class="col-md-3 col-md-offset-1">
              <button class="collasible"><b>3° Posso comprar ou vender mesmo não possuindo CPF ?</b></button>
                <div class="content" id="cor">
                <p><br><b>Não, você não poderá comprar ou vender livros sem CPF em mãos o CPF precisa ser do próprio titular caso contrário seu cadastro será anulado.</b></p>
                </div>
            </div>
          </div>
      </div>
