 ...
 <!DOCTYPE html>
  <html>
    <head>
      ...
      <link rel="stylesheet" type="text/css" href="css/stylequem_somos.css">
  ...
  <section class="container">
        ...
        <div class="container">
          <h1 class="center white-text main-text">Quem Somos</h1>
          <h5 class="center white-text light font center"><b>o grupo Booknow é responsável pelo sistema online aonde você pode <br>comprar e vender livros na comodidade do seu lar, nosso sistema<br> é seguro e de fácil acesso para você, que atualmente conta com<br> centenas de usuários e livros e uma grande variedade de gêneros<br> e autores para todos os gostos, e com várias formas de pagamento <br>facilitando na hora de vender e comprar.</b></h5>
        </div>
      </div>
