 ...
 <!DOCTYPE html>
  <html>
    <head>
      ...
      <link rel="stylesheet" type="text/css" href="css/stylesuporte.css">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-2 col-md-offset-3">
              ...
              if(!isset($_SESSION['email'])){ 
                echo'
              <a href="login.php" class="btn btn-lg btn-primary" id="grande"><i class="material-icons center" id="large">
              <br>do_not_disturb_on<br></i><br>Enviar Ticket</a>';
              }else{
                  echo'<a href="ticket.php" class="btn btn-lg btn-primary" id="grande"><i class="material-icons center" id="large">
                  <br>do_not_disturb_on<br></i><br>Enviar Ticket</a>';
              } ?>
            </div>
            <div class="col-md-2 col-md-offset-1">
              <a href="faq.php" class="btn btn-lg btn-success" id="grande"><i class="material-icons center" id="large"><br>info<br></i><br>F.A.Q<br>Perguntas<br> Frequentes</a>
            </div>
          </div>
        </div>
